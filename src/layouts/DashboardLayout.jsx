        ...
        <div className="p-4 md:p-6 flex items-center justify-between md:block">
          <div className="flex items-center text-slate-900 dark:text-white md:mb-8">
            ...
            <div className="flex items-center space-x-2">
              <Hexagon className="text-blue-500 w-6 h-6 hidden md:block" />
              ...
              return (
                <Link
                  ...
                  className={`flex items-center space-x-3 px-3 py-2 text-sm rounded-lg transition-colors ${
                    isActive ? 'bg-blue-600 text-white font-medium' : 'hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white'
                  }`}
                >
